        ...
        <div class="container">
            <div class="row justify-center">
                <div class="col-md-4 my-auto">
                    ...
                    <v-btn href="https://wa.me/+212 693385403?text=Hello Haytam how areou doing?" text class="py-8 my-2 w-100 border lighten-5 font-weight-bold" elevation="0">
                    ...
                    <v-btn :href="'mailto' + social.email" text class="py-8 my-2 w-100 border lighten-5 font-weight-bold" elevation="0">
                        <div class="col-icon blue-grey darken-4 mr-auto" style="height: 50px; width: 50px;">
                            <v-icon class="contact-social-icon white--text">mdi-email</v-icon>
                        </div>
                        hbakouane@gmail.com
                    </v-btn>
                    <v-btn :href="social.facebook" text class="py-8 my-2 w-100 border lighten-5 font-weight-bold" elevation="0">
                        <div class="col-icon blue-grey darken-4 mr-auto" style="height: 50px; width: 50px;">
                            <v-icon class="contact-social-icon white--text">mdi-facebook</v-icon>
                        </div>
                        Haytam Bakouane
                    </v-btn>
                    <v-btn :href="social.twitter" text class="py-8 my-2 w-100 border lighten-5 font-weight-bold" elevation="0">
                        <div class="col-icon blue-grey darken-4 mr-auto" style="height: 50px; width: 50px;">
                            <v-icon class="contact-social-icon white--text">mdi-twitter</v-icon>
                        </div>
                        @BakouaneH
                    </v-btn>
                </div>
                <div class="col-md-6">
                    <v-form v-model="contactForm" ref="contactForm">
                        <div v-if="loading">
                            ...
                            ></v-progress-linear>
                            <v-alert type="info" class="rounded-0" dense border="left" dismissible>Please wait . . .</v-alert>
                        </div>
                        <v-alert type="error" class="rounded-0" v-if="error" dense border="left" dismissible>All the fields are required.</v-alert>
                        <v-alert type="success" class="rounded-0" color="blue-grey darken-4" v-if="success" dense border="left" dismissible>Your message was sent successfully.</v-alert>
                        <div class="row">
